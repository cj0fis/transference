...
func _ready() -> void:
	...
	$"Pause Screen/pause panel/buttons/menu button".pressed.connect(_handle_menu_button_click)
	$"Pause Screen/pause panel/buttons/settings button".pressed.connect(_handle_settings_button_click)
	$"Pause Screen/pause panel/buttons/kys button".pressed.connect(_handle_kys_button_click)
	$"Pause Screen/pause panel/buttons/stats button".pressed.connect(_handle_stats_button_click)
	$"Pause Screen/pause panel/buttons/quit button".pressed.connect(_handle_quit_button_click)
...
func pause() -> void:
	...
	#smart_cam.attributes.set("dof_blur_far_enabled", true)
	t.tween_property(smart_cam.attributes, "dof_blur_amount", 0.5, pause_animation_time)
...
func unpause() -> void:
	...
	#smart_cam.attributes.set("dof_blur_far_enabled", false)
	t.tween_property(smart_cam.attributes, "dof_blur_amount", 0.0, pause_animation_time)
...
func _handle_stats_button_click() -> void:
	pass
	
func _handle_menu_button_click() -> void:
...
func _handle_kys_button_click() -> void:
	pass
